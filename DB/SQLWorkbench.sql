...
CREATE TABLE Doors (
	door_uuid VARCHAR(255) NOT NULL PRIMARY KEY,
    nickname VARCHAR(255) NOT NULL
);
CREATE TABLE Devices (
	device_id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    door_uuid VARCHAR(255) NOT NULL,
	nickname VARCHAR(255) NOT NULL,
...
('d5e1bbbc-2120-470b-ace2-4b14ef3415b9', 'local'),
...
INSERT INTO TempUpdate (lock_id) VALUES (1);
